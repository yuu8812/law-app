...
import { FormType } from "@/app/register/login/page";
      ...
      <div className="w-full lg:w-1/2">
        <div className="border-none lg:border-r-2">
          <CardHeader className="m-4 flex flex-col gap-2 ">
            ...
            <CardDescription>また一緒に盛り上げてくださいね</CardDescription>
            {/* mobile only */}
          ...
          <CardFooter className="flex flex-col border-t-2 items-center justify-around gap-4 mx-4 -mb-2 pt-4">
            <Button
              variant="default"
            ...
            <div className="border-t-2 w-full pt-4 flex items-center justify-center flex-col">
              ...
              <Button
                ...
                asChild={true}
              >
                <Link className="w-full" href="/register/signup">
                  アカウントを作る
                </Link>
              </Button>
            </div>
