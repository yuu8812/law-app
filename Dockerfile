...
ARG APP_PRIVATE_KEY_ID
ENV APP_PRIVATE_KEY_ID=$APP_PRIVATE_KEY_ID
ARG APP_PRIVATE_KEY
...
ARG APP_AUTH_URL
ENV APP_AUTH_URL=$APP_AUTH_URL
ARG APP_TOKEN_URL
ENV APP_TOKEN_URL=$APP_TOKEN_URL
ARG APP_AUTH_PROVIDER_X509_CERT_URL
ENV APP_AUTH_PROVIDER_X509_CERT_URL=$APP_AUTH_PROVIDER_X509_CERT_URL
ARG APP_CLIENT_X509_CERT_URL
ENV APP_CLIENT_X509_CERT_URL=$APP_CLIENT_X509_CERT_URL
ARG APP_UNIVERSE_DOMAIN
ENV APP_UNIVERSE_DOMAIN=$APP_UNIVERSE_DOMAIN

ARG NEXT_PUBLIC_API_URL
ENV NEXT_PUBLIC_API_URL=$NEXT_PUBLIC_API_URL
ARG NEXT_PUBLIC_API_SUB_URL
ENV NEXT_PUBLIC_API_SUB_URL=$NEXT_PUBLIC_API_SUB_URL
ARG NEXT_PUBLIC_X_HASURA_API_SECRET
ENV NEXT_PUBLIC_X_HASURA_API_SECRET=$NEXT_PUBLIC_X_HASURA_API_SECRET
ARG NEXT_PUBLIC_CLIENT_API_URL
ENV NEXT_PUBLIC_CLIENT_API_URL=$NEXT_PUBLIC_CLIENT_API_URL
ARG NEXT_PUBLIC_CLIENT_API_SUB_URL
ENV NEXT_PUBLIC_CLIENT_API_SUB_URL=$NEXT_PUBLIC_CLIENT_API_SUB_URL
