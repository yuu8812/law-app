      ...
      <div className="flex h-auto w-full flex-1 flex-col rounded bg-[#ffffff] shadow md:h-[500px] lg:w-[800px]">
        <div className="relative m-10 mb-10 flex flex-1 flex-col">
          ...
          <div className="flex flex-col gap-1 pt-10">
            <div className="">
              あなたの元へは毎日のように、今の地域を離れ移住をしたいさまざまな生物が集まってきます
            </div>
            <div className="">彼らのために素晴らしい地域を見つけて彼らを移住させましょう</div>
          </div>
          <div className="pt-10">
            <div className="font-bold">***気に入った地域がないですか?***</div>
            <div className="flex flex-col gap-1 pt-5">
              <div className="">ここでは好きなように地域と決まりを作ることができます</div>
              <div className="">あなたの地域を作って、新しい住人を迎えましょう</div>
            </div>
          </div>
        </div>
